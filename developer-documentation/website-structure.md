...
Both **version** and **category** content is obtained from the data file `source/_data/documentation.yml` and are autogenerated using their respective layouts, to know about the structure of the data file go to section [**documentation.yml**](https://github.com/CarbonLDP/carbonldp-website/task/%23161_website-developer-documentation/developer-documentation/website-structure.md#documentaiton.yml).
