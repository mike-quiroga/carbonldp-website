...
/// <reference path="./custom/ambient/highlightjs/index.d.ts" />
/// <reference path="./custom/ambient/angulartics2/index.d.ts" />

/// <reference path="./../../angular2-carbonldp/dist/bundles/angular2-carbonldp.d.ts" />
