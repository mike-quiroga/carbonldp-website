...
export default class BlogPostService {
	...
	static dependencies = BlogPostService.parameters;
	...
	getLatest():Promise<BlogPost[]> {
		return new Promise<BlogPost[]>( ( resolve, reject ) => {
			var blogPosts = [
				{
					title: 'A sample blog post',
					content: `
						<p class="lead">This blog post shows a few different types of content that's supported and styled with Bootstrap.
