...
public class JDBCApplicationDAO extends JdbcDAO implements ApplicationDAO {
	...
	public Application findByUUID(UUID uuid) throws CarbonException {
		...
		try {
			//@formatter:off
			application = template.execute(securityJDBCDataSource, new JDBCQueryTransactionCallback<Application>() {
				//@formatter:off
				@Override
	...
	public List<Application> getApplications() throws CarbonException {
		...
		try {
			//@formatter:off
			applications = template.execute(securityJDBCDataSource, new JDBCQueryTransactionCallback<List<Application>>() {
				//@formatter:off
				@Override
				public StringBuilder prepareSQLQuery(StringBuilder sqlBuilder) {
					//@formatter:off
