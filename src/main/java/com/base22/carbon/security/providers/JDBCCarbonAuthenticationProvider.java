package com.base22.carbon.security.providers;
...
public abstract class JDBCCarbonAuthenticationProvider {
	...
	public JDBCCarbonAuthenticationProvider() {
	...
	public void setAgentDetailsDAO(AgentLoginDetailsDAO agentDetailsDAO) {
