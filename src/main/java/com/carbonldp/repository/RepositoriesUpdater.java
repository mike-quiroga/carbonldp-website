...
public class RepositoriesUpdater extends AbstractComponent {
	...
	private static Map<RepositoryVersion, Action> versionsUpdates = new HashMap<RepositoryVersion, Action>() {{
		...
		put( new RepositoryVersion( "1.9.1" ), new UpdateAction1o9o1() );
		put( new RepositoryVersion( "1.10.0" ), new UpdateAction1o10o0() );
		put( new RepositoryVersion( "1.11.0" ), new UpdateAction1o11o0() );
		put( new RepositoryVersion( "1.12.0" ), new UpdateAction1o12o0() );
		put( new RepositoryVersion( "1.13.0" ), new UpdateAction1o13o0() );
		put( new RepositoryVersion( "1.14.0" ), new UpdateAction1o14o0() );
		put( new RepositoryVersion( "1.15.0" ), new UpdateAction1o15o0() );
		put( new RepositoryVersion( "1.16.0" ), new UpdateAction1o16o0() );
		put( new RepositoryVersion( "1.17.0" ), new UpdateAction1o17o0() );
		put( new RepositoryVersion( "1.18.0" ), new UpdateAction1o18o0() );
	}};
