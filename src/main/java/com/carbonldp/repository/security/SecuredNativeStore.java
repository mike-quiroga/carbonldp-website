...
public class SecuredNativeStore extends NativeStore {
	...
	// TODO: See what happened with "createStatementIterator"

//	@Override
//	protected CloseableIteration<? extends Statement, IOException> createStatementIterator( Resource subj, IRI pred, Value obj, boolean includeInferred, boolean readTransaction, Resource... contexts ) throws IOException {
