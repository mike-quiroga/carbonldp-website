...
public abstract class AbstractWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	protected JWTokenAuthenticationFilter jwTokenAuthenticationFilter;

	@Autowired
	protected JWTicketAuthenticationFilter jwTicketAuthenticationFilter;
	...
	protected void configure( HttpSecurity http ) throws Exception {
		...
		http
			...
			.addFilterAfter( jwTokenAuthenticationFilter, BasicAuthenticationFilter.class )
			.addFilterAfter( jwTicketAuthenticationFilter,JWTokenAuthenticationFilter.class )
