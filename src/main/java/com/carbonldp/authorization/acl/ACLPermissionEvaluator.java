...
public class ACLPermissionEvaluator implements PermissionEvaluator {
	...
	private Set<Permission> resolvePermissions(Object permission) {
		...
		if ( permission instanceof Permission[] ) return new HashSet<Permission>(Arrays.asList((Permission[]) permission));
		;
	...
	private Set<Permission> resolvePermissions(String[] permissionStrings) {
		...
		for (String permissionString : permissionStrings) {
			...
			if ( URIUtil.isHTTPUri(permissionString) ) permission = RDFNodeUtil.findByURI(new URIImpl(permissionString), Permission.class);
