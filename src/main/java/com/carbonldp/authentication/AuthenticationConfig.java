...
import com.carbonldp.apps.roles.PlatformAppRolePersistenceFilter;
...
public class AuthenticationConfig {
	...
	@Bean
	public PlatformAppRolePersistenceFilter platformAppRolePersistanceFilter() {
		return new PlatformAppRolePersistenceFilter( appRoleRepository );
	}
